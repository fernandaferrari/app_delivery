...
VALUES ('X-Tudão + Suco', '', 12.99, '/xtudo_suco.jpeg');

INSERT INTO produto(nome, descricao, preco, imagem)
VALUES ('Misto Quente', 'Pão, presunto, muçarela, Orégano', 6.99, '/xtudo_suco.jpeg');

INSERT INTO produto(nome, descricao, preco, imagem)
VALUES ('X-Quente', 'Pão, Hambúrger (Tradicional 56g), Muçarela e Tomate', 10.99, '/xtudo_suco.jpeg');
